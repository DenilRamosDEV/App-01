...
class CasaRudoActivity : AppCompatActivity() {
    //variables
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_casa_rudo)
        ...
        cvHtml.setOnClickListener { showCourseInfoDialog("Curso HTML Avanzado, disponible próximamente") }
        cvPy.setOnClickListener { showCourseInfoDialog("Curso Python Avanzado, disponible próximamente") }
        cvKt.setOnClickListener { showCourseInfoDialog("Curso Kotlin Avanzado, disponible próximamente") }
        cvJv.setOnClickListener { showCourseInfoDialog("Curso Java Avanzado, disponible próximamente") }
    }
