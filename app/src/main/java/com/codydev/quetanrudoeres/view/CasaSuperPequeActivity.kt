...
class CasaSuperPequeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_casa_super_peque)
        ...
        cvHtml.setOnClickListener { showCourseInfoDialog("Curso HTML Básico, disponible próximamente") }
        cvPy.setOnClickListener { showCourseInfoDialog("Curso Python Básico, disponible próximamente") }
        cvKt.setOnClickListener { showCourseInfoDialog("Curso Kotlin Básico, disponible próximamente") }
        cvJv.setOnClickListener { showCourseInfoDialog("Curso Java Básico, disponible próximamente") }
    }
    ...
    // Función para mostrar un diálogo informativo
